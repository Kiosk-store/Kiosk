      ...
      <div className="max-w-7xl mx-auto bg-primary rounded-[40px] p-10 md:p-20 text-center text-on-primary relative overflow-hidden shadow-2xl shadow-primary/20">
        ...
        <div className="relative z-10 max-w-2xl mx-auto space-y-8">
          ...
          <p className="text-body-lead text-white/90">
            Join over 50 small businesses who trust Kiosk for their digital presence.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
            <button className="bg-white text-primary px-9 py-4 rounded-full font-bold text-base hover:bg-opacity-95 transition-all duration-300 hover:scale-105 active:scale-95 shadow-xl cursor-pointer">
              Get Started Now
            </button>
            <button className="bg-white/10 text-white px-9 py-4 rounded-full font-bold text-base border border-white/30 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 cursor-pointer">
              Talk to an Expert
            </button>
          </div>
        </div>
