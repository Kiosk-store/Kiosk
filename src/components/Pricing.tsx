...
const tiers = [
	{
		...
		priceMonthly: "$49",
		description:
			"Perfect for new businesses needing a crisp, high-converting digital business card.",
		features: [
	...
	},
	{
		...
		priceMonthly: "$89",
		description:
			"Multi-page growth engine engineered to convert traffic into paying customers.",
		features: [
	...
	},
	{
		...
		priceMonthly: "$129",
		description:
			"Full-featured online store with seamless inventory and checkout flow.",
		features: [
...
export default function Pricing() {
	...
	return (
		<section
			id="pricing"
			className="pt-0 pb-20 md:pb-28 lg:pb-32 px-4 sm:px-6 lg:px-8 bg-surface-container-low relative overflow-hidden">
			{/* Background Accent */}
			...
			<div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch relative z-10">
				{tiers.map((tier) => {
					const price =
						billingCycle === "one-time" ? tier.priceOneTime : tier.priceMonthly;
					const period =
						billingCycle === "one-time" ? "one-time payment" : "/ month";
					...
					return (
						<div
							...
							<div>
								...
								{/* Plan Name */}
								<h3 className="font-card-title text-on-surface mb-2">
									{tier.name}
								</h3>
								...
								<ul className="space-y-3.5 mb-8">
									{tier.features.map((feature) => (
										<li
											key={feature}
											className="flex items-center gap-3 text-sm text-on-surface font-medium">
