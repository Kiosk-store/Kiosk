					...
					<div className="grid grid-cols-1 gap-6">
						{testimonials.map((t, i) => (
							<ScrollReveal
								...
								direction="up"
								delay={i * 150}>
								<div className="bg-surface p-8 rounded-[28px] border border-outline-variant/40 shadow-sm hover:shadow-xl hover:border-primary/30 transition-all duration-300 relative group">
									{/* Rating Stars */}
