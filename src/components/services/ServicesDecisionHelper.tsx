...
export default function ServicesDecisionHelper() {
	...
	return (
		<section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
			<ScrollReveal direction="up" delay={0}>
				<div className="bg-white border border-gray-200/90 rounded-3xl p-8 sm:p-12 text-center shadow-2xs">
						...
						{DECISION_OPTIONS.map((q, index) => (
							<ScrollReveal key={q.id} direction="up" delay={100 + index * 90}>
								<button
									...
									<div className="flex items-center justify-between text-xs font-bold text-blue-600 pt-3 border-t border-gray-100">
