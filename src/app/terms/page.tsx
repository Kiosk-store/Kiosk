			...
			<section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full flex-1 space-y-10 text-slate-700 text-sm leading-relaxed">
				...
				<div className="space-y-4">
					...
					<ul className="list-disc pl-6 space-y-2 text-slate-700">
						<li>
							<strong className="text-slate-900">Recurring Billing:</strong> Subscriptions are billed automatically on a monthly or annual recurring basis via our secure payment processor (Paystack).
						</li>
						<li>
