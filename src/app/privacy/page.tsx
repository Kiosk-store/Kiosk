			...
			<section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full flex-1 space-y-10 text-slate-700 text-sm leading-relaxed">
				...
				<div className="space-y-4">
					...
					<ul className="list-disc pl-6 space-y-2.5 text-slate-700">
						...
						<li>
							<strong className="text-slate-900">Payment & Billing Data:</strong> Payment card details and transaction history processed through secure PCI-compliant third-party gateway (Paystack). Kiosk does not store raw credit card numbers on our servers.
						</li>
						<li>
				...
				<div className="space-y-4">
					...
					<ul className="list-disc pl-6 space-y-2 text-slate-700">
						...
						<li>
							<strong className="text-slate-900">Payment Processing:</strong> Paystack for processing subscription billing and transactions.
						</li>
						<li>
